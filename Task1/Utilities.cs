...
namespace Task1
{
    public static class Utilities
    {
        ...
        {
            if (numbers == null) throw new ArgumentNullException("arguments received null in Sort method");
        ...
        {
            if (products == null || predicate == null) throw new ArgumentNullException("arguments received null in IndexOf method");
